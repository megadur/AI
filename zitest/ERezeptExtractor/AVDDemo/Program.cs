...
namespace AVDDemo
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                if (!File.Exists(specificationPath))
                {
                    ...
                    Console.WriteLine("\nContinuing with a simple demo...");
                    RunSimpleDemo(extractor);
                }
                else
                {
                    RunFullDemo(extractor, specificationPath);
                }
            }
            catch (Exception ex)
            {
        ...
        private static void RunFullDemo(AVDBasedExtractor extractor, string specificationPath)
        {
