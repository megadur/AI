...
try
{
    ...
    Console.WriteLine("6. Saving report to file...");
    var outputPath = Path.Combine(Directory.GetCurrentDirectory(), "sample_ta7_report.xml");
    await File.WriteAllTextAsync(outputPath, xml);
    Console.WriteLine($"   ✅ Report saved to: {outputPath}");
    Console.WriteLine();

    Console.WriteLine("7. Creating custom report...");
